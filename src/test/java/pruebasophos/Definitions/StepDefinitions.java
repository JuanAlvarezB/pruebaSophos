...
public class StepDefinitions {
    ...
    public Credenciales credenciales(Map<String, String> prop) {
        return new Credenciales(prop.get("user"),
                prop.get("password")
        );
    }
    ...
    public CicloTres cicloTres(Map<String, String> prop) {
        return new CicloTres(prop.get("letra"),
                prop.get("numeroRespuesta")
        );
    }

    @DataTableType
    public CicloCuatro cicloCuatro(Map<String, String> prop) {
        return new CicloCuatro(prop.get("letraZ"),
                prop.get("numeroRespuestaDos")
        );
    }

    @DataTableType
    public CicloCinco cicloCinco(Map<String, String> prop) {
        return new CicloCinco(prop.get("selectCicloCinco"),
                prop.get("numeroSecuencia")
        );
    }
